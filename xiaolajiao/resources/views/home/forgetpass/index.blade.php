 ...
 <div class="suc_content forgetpassword">
  ...
  <div class="suc_kuang">
    ...
    <div class="hei_513" id="getPasswordArea">
      ...
      <form id="forgetPassword" action="/home/findpass/cph" method="post">
          {{ csrf_field() }}

          <p class="p_tips">请输入您注册小辣椒帐户的手机号码：</p>

          <div id="forget" class="forget_area">

            <input type="text" id="user" name="phone" value="手机号码" style="float:left;" class="inputBg input_kuang6">
