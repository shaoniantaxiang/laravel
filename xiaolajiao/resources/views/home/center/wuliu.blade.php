	...
	<!-- <h3><a href="user.php">会员中心</a></h3> -->
		<div class="portal_list">
			...
			<ul class="about_menu">
		        ...
		        <li><a href="/home/center/inx"> 我的订单</a></li>
		        <li class="dianji"><a href="/home/center/wul"> 物流查询</a></li>
			</ul>
		</div>
		<div class="portal_list">
...
<div class="row">
    <h2 class="font-size-16 color-333 border-bottom">查看物流状态 &nbsp;<small class="color-666">（由于数据同步可能带来订单信息及订单状态显示滞后，请稍等一会儿。）</small></h2>

	<p>输入快递单号：<input type="text" id="code" style="border:1px solid #ccc;"/></p>
	<button onclick="dogetstate()">查询</button>
	<table id="showinfo" width="600px">
			...
			$.ajax({
				...
				success:function(event){
					...
					for (var i = 0; i < event.length; i++) {
						var tr = '<tr><td>'+$(event[i]).attr('time')+'</td><td>'+$(event[i]).attr('context')+'</td></tr>';
						$('#showinfo').append(tr);
					};
				},
			});
